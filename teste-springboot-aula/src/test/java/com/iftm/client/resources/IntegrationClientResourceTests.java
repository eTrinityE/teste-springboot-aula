...
public class IntegrationClientResourceTests {
    ...
    public void testarEndPointRetornaTodosOsRegistros() throws Exception {
        ...
        ResultActions resultadoEsperado = mockMvc.perform(get("/clients/")
    ...
    public void verificaSeOEndpointRetornaOClienteCorretoQuandoOIDExiste() throws Exception{
        ...
        ResultActions resultadoEsperado = mockMvc.perform(get("/clients/{id}", idExistente)
                .accept(MediaType.APPLICATION_JSON));
    ...
    public void testaRetornoSucessoDelete() throws Exception {
        ...
        ResultActions resultadoEsperado = mockMvc.perform(delete("/clients/{id}",idExistente)
                .accept(MediaType.APPLICATION_JSON));

        resultadoEsperado.andExpect(status().is2xxSuccessful());
    }
    ...
    public void testaRetornoErroDelete() throws Exception {
        ...
        resultadoEsperado.andExpect(status().is4xxClientError());
    }
    ...
    public void testaRetornoSucessoInsert() throws Exception {
        ...
        ResultActions expectedResult = mockMvc.perform(post("/clients/")
                .content(json)
                .contentType(MediaType.APPLICATION_JSON)
                .accept(MediaType.APPLICATION_JSON));

        expectedResult.andExpect(status().isCreated())
                .andExpect(jsonPath("$.name").exists())
    ...
    public void testaRetornoSucessoUpdate() throws Exception {
        ...
        ResultActions expectedResult = mockMvc.perform(put("/clients/")
                .content(json)
                .contentType(MediaType.APPLICATION_JSON)
                .accept(MediaType.APPLICATION_JSON));
    ...
    public void testaRetornoErroUpdate() throws Exception {
        ...
        ResultActions expectedResult = mockMvc.perform(put("/clients/{id}", client.getId())
                .content(json)
                .contentType(MediaType.APPLICATION_JSON)
                .accept(MediaType.APPLICATION_JSON));

        expectedResult.andExpect(status().isNotFound())
    ...
    public void testarEndPointRetornaRegistrosEspecificosFindByIncome() throws Exception {
        ResultActions resultadoEsperado = mockMvc.perform(get("/clients/incomeGreaterThan/")
